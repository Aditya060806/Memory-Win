...
namespace MemoryWin
{
    ...
    public static class Constants
    {
        public static class App
        {
            ...
            {
                public static readonly Uri BitcoinUri = new Uri("https://www.blockchain.com/explorer/addresses/btc/YOUR_BTC_ADDRESS_HERE");
                public static readonly Uri EthereumUri = new Uri("https://www.blockchain.com/explorer/addresses/eth/YOUR_ETH_ADDRESS_HERE");
                public static readonly Uri GitHubSponsorUri = new Uri("https://github.com/sponsors/Aditya060806");
                public static readonly Uri KofiUri = new Uri("https://ko-fi.com/aditya060806");
            }
            ...
            public static class Registry
            {
                ...
                {
                    public const string ProcessExclusionList = @"SOFTWARE\MemoryWin\ProcessExclusionList";
                    public const string Settings = @"SOFTWARE\MemoryWin";
                }
            }

            public static class Repository
            {
                private const string GitHub = "https://github.com/Aditya060806/Memory-Win";
                private const string GitHubRaw = "https://raw.githubusercontent.com/Aditya060806/Memory-Win/main";

                public static readonly Uri AboutUri = new Uri(GitHub + "?tab=readme-ov-file#memory-win");
                ...
                public static readonly Uri LatestExeUri = new Uri(GitHub + "/releases/latest/download/MemoryWin.exe");
