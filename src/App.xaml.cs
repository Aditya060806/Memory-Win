                    ...
                    try
                    {
                        var taskXml = string.Format
                            (
                                ...
                                string.Format(CultureInfo.InvariantCulture, "Memory-Win {0} ({1})", string.Format(Localizer.Culture, Constants.App.VersionFormat, Version.Major, Version.Minor, Version.Build), Environment.UserName),
